...
enum opt_code
{
  ...
  OPT_mfloat_abi_ = 1157,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1158,                  /* -mfp16-format= */
  OPT_mfpu_ = 1159,                          /* -mfpu= */
  OPT_mglibc = 1160,                         /* -mglibc */
  /* OPT_mhard_float = 1161, */              /* -mhard-float */
  OPT_mlittle_endian = 1162,                 /* -mlittle-endian */
  OPT_mlong_calls = 1163,                    /* -mlong-calls */
  OPT_mmusl = 1164,                          /* -mmusl */
  OPT_mneon_for_64bits = 1165,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1166,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1167,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1168,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1169,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1170,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1171,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1172,                   /* -mrestrict-it */
  OPT_msched_prolog = 1173,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1174,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1175,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1176, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1177,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1178,                         /* -mthumb */
  OPT_mthumb_interwork = 1179,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1180,                  /* -mtls-dialect= */
  OPT_mtp_ = 1181,                           /* -mtp= */
  OPT_mtpcs_frame = 1182,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1183,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1184,                         /* -mtune= */
  OPT_muclibc = 1185,                        /* -muclibc */
  OPT_munaligned_access = 1186,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1187,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1188,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1189,              /* -mword-relocations */
  OPT_n = 1190,                              /* -n */
  ...
  OPT_pie = 1205,                            /* -pie */
  OPT_pipe = 1206,                           /* -pipe */
  OPT_posix = 1207,                          /* -posix */
  OPT_print_file_name_ = 1208,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1209,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1210,          /* -print-multi-directory */
  OPT_print_multi_lib = 1211,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1212,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1213,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1214,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1215,               /* -print-prog-name= */
  OPT_print_search_dirs = 1216,              /* -print-search-dirs */
  OPT_print_sysroot = 1217,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1218,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1219,                        /* -profile */
  OPT_pthread = 1220,                        /* -pthread */
