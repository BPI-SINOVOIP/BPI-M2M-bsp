...
#define MACRONIX                0xc2                //Macronix nand flash manufacture number
#define WINBOND                	0xef                //Winbond nand flash manufacture number
#define FIDELIX                	0xf8                //Fidelix nand flash manufacture number
#define ESMT                	0xc8                //Esmt nand flash manufacture number
#define SPECTEK                 0xb5                //spectek nand flash manufacture number
