...
__s32 NFC_ReadRetry_exit_Toshiba(void); //toshiba readretry exit
...
__s32 NFC_Write_0xFF_8K(NFC_CMD_LIST * wcmd, void * mainbuf, void * sparebuf, __u8 dma_wait_mode, __u8 rb_wait_mode, __u8 page_mode);
