...
static __u32		video_on;
static __u32		audio_on;
static bool		video_enable;
static bool		audio_enable;
static __u32		cts_enable;
static __u32		hdcp_enable;
static __s32		HPD;
