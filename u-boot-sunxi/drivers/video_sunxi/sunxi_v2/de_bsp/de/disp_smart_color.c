...
struct disp_smcl_private_data *disp_smcl_get_priv(struct disp_smcl *smcl)
{
	if(NULL == smcl) {
		DE_INF("NULL hdl!\n");
		return NULL;
...
s32 disp_smcl_sync(struct disp_smcl* smcl)
{
...
s32 disp_smcl_update_regs(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
#if defined(__LINUX_PLAT__)
  {
  	...
  	spin_lock_irqsave(&smcl_data_lock, flags);
		...
		DE_INF("smcl_update_regs ok, enable=%d, <%d,%d,%d>,mode=%d\n", smcl_info.enable, smcl_info.bright, smcl_info.saturation, smcl_info.hue, smcl_info.mode);
#if defined(__LINUX_PLAT__)
		spin_unlock_irqrestore(&smcl_data_lock, flags);
	}
#endif
...
s32 disp_smcl_apply(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_force_update_regs(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
/* seem no meaning */
bool disp_smcl_is_enabled(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_enable(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_disable(struct disp_smcl* smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_bright(struct disp_smcl* smcl, u32 val)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_saturation(struct disp_smcl* smcl, u32 val)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_hue(struct disp_smcl* smcl, u32 val)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_mode(struct disp_smcl* smcl, u32 val)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_window(struct disp_smcl* smcl, disp_window *window)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_set_manager(struct disp_smcl* smcl, struct disp_manager *mgr)
{
...
s32 disp_smcl_notifier_callback(struct disp_notifier_block *self,
...
s32 disp_smcl_init(struct disp_smcl *smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
...
s32 disp_smcl_exit(struct disp_smcl *smcl)
{
	struct disp_smcl_private_data *smclp = disp_smcl_get_priv(smcl);
