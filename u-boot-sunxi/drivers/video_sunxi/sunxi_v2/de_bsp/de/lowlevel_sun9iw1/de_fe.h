...
extern s32 iDE_SCAL_Matrix_Mul(__scal_matrix4x4 in1, __scal_matrix4x4 in2, __scal_matrix4x4 *result);
extern s32 iDE_SCAL_Csc_Lmt(__s64 *value, s32 min, s32 max, s32 shift, s32 validbit);
