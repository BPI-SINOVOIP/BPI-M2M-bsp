...
s32 DE_BE_Layer_Video_Ch_Sel(u32 sel, u8 layidx,bool scaler_index)
{
...
s32 DE_BE_Layer_Set_Alpha_Value(u32 sel, u8 layidx,u8 alpha_val)//todo,why???
{
...
static s32 DE_BE_YUV_CH_Cfg_Csc_Coeff(u32 sel, u8 cs_mode)//todo
{
	u32 csc_coef_off;
	u32 *pdest_end;
    u32 *psrc_cur;
