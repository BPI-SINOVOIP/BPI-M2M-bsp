...
/* todo? the fb will be clear when BE's clock reset
...
struct disp_cursor_private_data *disp_cursor_get_priv(struct disp_cursor *cursor)
{
	if(NULL == cursor) {
		DE_WRN("NULL hdl!\n");
		return NULL;
...
s32 disp_cursor_sync(struct disp_cursor* cursor)
{
...
s32 disp_cursor_update_regs(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
	bool info_dirty, info_dirty_p;
...
s32 disp_cursor_apply(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_force_update_regs(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
/* seem no meaning */
bool disp_cursor_is_enabled(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_enable(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_disable(struct disp_cursor* cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_set_palette(struct disp_cursor* cursor, void *palette, u32 offset, u32 palette_size)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_set_fb(struct disp_cursor* cursor, disp_cursor_fb *fb)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_set_pos(struct disp_cursor* cursor, disp_position *pos)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_get_pos(struct disp_cursor* cursor, disp_position *pos)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_set_manager(struct disp_cursor* cursor, struct disp_manager *mgr)
{
...
s32 disp_cursor_notifier_callback(struct disp_notifier_block *self,
...
s32 disp_cursor_init(struct disp_cursor *cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
...
s32 disp_cursor_exit(struct disp_cursor *cursor)
{
	struct disp_cursor_private_data *cursorp = disp_cursor_get_priv(cursor);
