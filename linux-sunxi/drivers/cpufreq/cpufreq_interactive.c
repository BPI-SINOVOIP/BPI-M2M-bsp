...
struct cpufreq_interactive_tunables {
	...
	#define DEFAULT_HISPEED_FREQ_LITTLE      (864000)
       ...
       #define DEFAULT_HISPEED_FREQ_LITTLE      (1608000)
...
#elif defined(CONFIG_ARCH_SUN8IW6P1) || defined(CONFIG_ARCH_SUN8IW9P1)
       #define DEFAULT_INPUT_EVENT_FRFQ_LITTLE    (1608000)
...
static struct input_handler cpufreq_iactive_input_hdl = {
		...
		unsigned int event)
{
	...
	if (!input_handler_register_count) {
		...
		ret = input_register_handler(&cpufreq_iactive_input_hdl);
	}
...
#elif defined(CONFIG_ARCH_SUN8IW5P1) || defined(CONFIG_ARCH_SUN8IW6P1) || defined(CONFIG_ARCH_SUN8IW7P1) || defined(CONFIG_ARCH_SUN8IW8P1) || defined(CONFIG_ARCH_SUN8IW9P1)
		tunables->input_event_freq = DEFAULT_INPUT_EVENT_FRFQ_LITTLE;
#endif
	...
	case CPUFREQ_GOV_POLICY_EXIT:
		...
		if(!input_handler_register_count) {
			cpumask_clear(&interactive_cpumask);
			input_unregister_handler(&cpufreq_iactive_input_hdl);
		}
#endif
