...
static unsigned int hotplug_period_us = 20000;
...
unsigned int load_try_down          = 20;
unsigned int load_save_up           = 50;
unsigned int load_try_up            = 60;
unsigned int load_try_boost         = 95;

unsigned int load_last_big_min_freq = 300000;
unsigned int load_up_stable_us      = 20000;
