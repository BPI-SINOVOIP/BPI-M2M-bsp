...
{
	short x,y,z,report_x,report_y,report_z;
	int result;
  ...
  report_x = mma8452_rotation[0]*x + mma8452_rotation[1]*y + mma8452_rotation[2]*z;
  report_y = mma8452_rotation[3]*x + mma8452_rotation[4]*y + mma8452_rotation[5]*z;
  report_z = mma8452_rotation[6]*x + mma8452_rotation[7]*y + mma8452_rotation[8]*z;
  
	dprintk(DEBUG_DATA_INFO, "x= 0x%hx, y = 0x%hx, z = 0x%hx\n", report_x, report_y, report_z);
	input_report_abs(mma8452_idev->input, ABS_X, report_x);
	input_report_abs(mma8452_idev->input, ABS_Y, report_y);
	input_report_abs(mma8452_idev->input, ABS_Z, report_z);
...
/*
  ...
  {
  	case 0:
  	    mma8452_rotation[0] = 1;
  	    mma8452_rotation[1] = 0;
  	    mma8452_rotation[2] = 0;
  	    mma8452_rotation[3] = 0;
  	    mma8452_rotation[4] = 1;
  	    mma8452_rotation[5] = 0;
  	    mma8452_rotation[6] = 0;
  	    mma8452_rotation[7] = 0;
  	    mma8452_rotation[8] = 1;
  	    break;
  	case 1:
  	    mma8452_rotation[0] = 0;
  	    mma8452_rotation[1] = 1;
  	    mma8452_rotation[2] = 0;
  	    mma8452_rotation[3] = 1;
  	    mma8452_rotation[4] = 0;
  	    mma8452_rotation[5] = 0;
  	    mma8452_rotation[6] = 0;
  	    mma8452_rotation[7] = 0;
  	    mma8452_rotation[8] = 1;
