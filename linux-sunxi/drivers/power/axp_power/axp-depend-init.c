 ...
 * */
static unsigned int sys_pwr_dm_mask = 0;

static unsigned int power_regu_tree[VCC_MAX_INDEX] = {0};
 ...
 *
 * */
unsigned int get_sys_pwr_dm_mask(void)
{
	unsigned long irqflags;
	unsigned int ret = 0;
...
static int axp81x_regu_dependence(const char *ldo_name)
{
	int axp81x_dependence = 0;
