 ...
 */
/*
 * A V4L2 driver for GC2355_mipi cameras.
 *
 */
...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for GC2355_mipi sensors");
MODULE_LICENSE("GPL");

//for internel driver debug
#define DEV_DBG_EN      0 
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[GC2355_mipi]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[GC2355_mipi]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[GC2355_mipi]"x,##arg)
...
/*
 * The gc2355_mipi sits on i2c with ID 0x6c
 */
...
//	vfe_dev_dbg("sensor_set_exposure = %d\n", exp_val>>4);
	...
	//printk("gc2355_mipi sensor_set_exp = %d, Done!\n", exp_val);
...
//	printk("gc2355_mipi ID_VAL_HIGH = %2x, Done!\n", rdval);

  LOG_ERR_RET(sensor_read(sd, ID_REG_LOW, &rdval))
  if(rdval != ID_VAL_LOW)
    return -ENODEV;
  
//	printk("gc2355_mipi ID_VAL_LOW = %2x, Done!\n", rdval);
