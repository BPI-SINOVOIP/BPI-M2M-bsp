...
static struct regval_list sensor_default_regs[] = {
	...
	{0xe9,0x30},   //sharpness gain for increasing pixel��s Y, in normal
	{0xed,0x40},   //sharpness gain for decreasing pixel��s Y, in normal
	...
	{0xdc,0x03},		//skin_sharp_sel��ɫ����
	{0x05,0x00},		//skin_num_th2�ų���ɫ���񻯶Էֱ��ʿ�����ĸ���
