 ...
 */
/*
 * A V4L2 driver for ov5640_mipi cameras.
 *
 */
...
#define DEV_DBG_EN      1
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[OV5640_mipi]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[OV5640_mipi]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[OV5640_mipi]"x,##arg)


#define CAP_BDG 0
#if(CAP_BDG == 1)
#define vfe_dev_cap_dbg(x,arg...) printk("[OV5640_mipi_CAP_DBG]"x,##arg)
#else
...
static struct regval_list sensor_default_regs[] = {
#ifndef REG_DEBUG1
  {0x3103,0x11},//PLL clock select,pad clock
  {0x3008,0x82},//reset
  {REG_DLY,0x1e},//delay 30ms
  {0x3008,0x42},//release from reset and power down
  {0x3103,0x03},//PLL clock select,PLL clock
  {0x3017,0x00},//disable oe
  {0x3018,0x00},//pad clock divider for SCCB Clock
  //pll and clock setting
  {0x3034,0x18},//
  {0x3035,0x12},//system clock divider
  {0x3036,0x54},//0x46->30fps,0x54->15fps,PLL multiplier
  {0x3037,0x13},//div,PLL root divider
  {0x3108,0x01},//0x1b},//SCLK divider
  ...
  {0x3600,0x08},//VCM
  {0x3601,0x33},//VCM
  {0x302d,0x60},//system control register
  {0x3620,0x52},//
  {0x371b,0x20},//
  {0x471c,0x50},//
  {0x3a13,0x43},//AEC
  {0x3a18,0x00},//Gain Output Top Limit,AEC gain ceiling[9:8]
  {0x3a19,0xf8},//Gain Output Top Limit,AEC gain ceiling[7:0]
  {0x3635,0x13},//
  {0x3636,0x03},//
  {0x3634,0x40},//
  {0x3622,0x01},//
  //5060HZ detector register
  {0x3c01,0x34},//5060HZ,auto
  {0x3c04,0x28},//
  {0x3c05,0x98},//
  {0x3c06,0x00},//
  {0x3c08,0x00},//
  ...
  {0x3820,0x41},// mirror and flip registers
  {0x3821,0x07},// 
  //image windows control register
  {0x3814,0x31},//
  {0x3815,0x31},//
  {0x3800,0x00},//
  {0x3801,0x00},//
  ...
  {0x4001,0x02},//
  {0x4004,0x02},//
  {0x3000,0x00},//system reset,0--enable block
  {0x3002,0x1c},//
  {0x3004,0xff},//
  {0x3006,0xc3},//
  {0x300e,0x25},//MIPI control,B2=1,mipi enable
  {0x302e,0x08},//
  ...
  {0x5180,0xff},  //0xff},	// 0xff    0xff
	...
	{0x5186,0x09},  //0x1c}, // 0x09    0x1c              	
	{0x5187,0x09},  //0x18}, // 0x09    0x18              	
	{0x5188,0x09},  //0x18}, // 0x09    0x18              	
	{0x5189,0x75},  //0x6e}, // 0x75    0x6e             	
	{0x518a,0x54},  //0x68}, // 0x54    0x68             	
	{0x518b,0xe0},  //0xa8}, // 0xe0    0xa8             	
	{0x518c,0xb2},  //0xa8}, // 0xb2    0xa8             	
	{0x518d,0x42},  //0x3d}, // 0x42    0x3d             	
	{0x518e,0x3d},  //0x3d}, // 0x3d    0x3d             	
	{0x518f,0x56},  //0x54}, // 0x56    0x54             	
	{0x5190,0x46},  //0x54}, // 0x46    0x54             	
  ...
  //Color                   // LA      ORG      
	...
	{0x5383,0x08},  //0x08}, // 0x08    0x08
	{0x5384,0x0a},  //0x0a}, // 0x0a    0x05
	{0x5385,0x7e},  //0x7e}, // 0x7e    0x72
	{0x5386,0x88},  //0x88}, // 0x88    0x77
	{0x5387,0x7c},  //0x7c}, // 0x7c    0x6d
	{0x5388,0x6c},  //0x6c}, // 0x6c    0x4d
	{0x5389,0x10},  //0x10}, // 0x10    0x20
  ...
  {0x530c,0x06}, 
	...
	//Gamma        
  {0x5480,0x01},  //???     // LA     ORG
  {0x5481,0x08},  //0x08},  // 0x08     0x06
  {0x5482,0x14},  //0x14},  // 0x14     0x15
  {0x5483,0x28},  //0x28},  // 0x28     0x28
  {0x5484,0x51},  //0x51},  // 0x51     0x3b
  {0x5485,0x65},  //0x65},  // 0x65     0x50
  {0x5486,0x71},  //0x71},  // 0x71     0x5d
  {0x5487,0x7d},  //0x7d},  // 0x7d     0x6a
  {0x5488,0x87},  //0x87},  // 0x87     0x75
  {0x5489,0x91},  //0x91},  // 0x91     0x80
  {0x548a,0x9a},  //0x9a},  // 0x9a     0x8a
  {0x548b,0xaa},  //0xaa},  // 0xaa     0x9b
  {0x548c,0xb8},  //0xb8},  // 0xb8     0xaa
  {0x548d,0xcd},  //0xcd},  // 0xcd     0xc0
  {0x548e,0xdd},  //0xdd},  // 0xdd     0xd5
  {0x548f,0xea},  //0xea},  // 0xea     0xe8
  {0x5490,0x1d},  //0x1d},  // 0x1d     0x20
  ...
  //Lens Shading 
   {0x5800,0x23},    //0xa7}, //LA        org
  {0x5801,0x14},    //0x23}, //0x23      0x17
  {0x5802,0x0f},    //0x14}, //0x14      0x10
  {0x5803,0x0f},    //0x0f}, //0x0f      0x0e
  {0x5804,0x12},    //0x0f}, //0x0f      0x0e
  {0x5805,0x26},    //0x12}, //0x12      0x11
  {0x5806,0x0c},    //0x26}, //0x26      0x1b
  {0x5807,0x08},    //0x0c}, //0x0c      0x0b
  {0x5808,0x05},    //0x08}, //0x08      0x07
  {0x5809,0x05},    //0x05}, //0x05      0x05
  {0x580A,0x08},    //0x05}, //0x05      0x06
  {0x580B,0x0d},    //0x08}, //0x08      0x09
  {0x580C,0x08},    //0x0d}, //0x0d      0x0e
  {0x580D,0x03},    //0x08}, //0x08      0x06
  {0x580E,0x00},    //0x03}, //0x03      0x02
  {0x580F,0x00},    //0x00}, //0x00      0x00
  {0x5810,0x03},    //0x00}, //0x00      0x00
  {0x5811,0x09},    //0x03}, //0x03      0x03
  {0x5812,0x07},    //0x09}, //0x09      0x09
  {0x5813,0x03},    //0x07}, //0x07      0x06
  {0x5814,0x00},    //0x03}, //0x03      0x03
  {0x5815,0x01},    //0x00}, //0x00      0x00
  {0x5816,0x03},    //0x01}, //0x01      0x00
  {0x5817,0x08},    //0x03}, //0x03      0x03
  {0x5818,0x0D},    //0x08}, //0x08      0x09
  {0x5819,0x08},    //0x0d}, //0x0d      0x0b
  {0x581A,0x05},    //0x08}, //0x08      0x08
  {0x581B,0x06},    //0x05}, //0x05      0x05
  {0x581C,0x08},    //0x06}, //0x06      0x05
  {0x581D,0x0e},    //0x08}, //0x08      0x08
  {0x581E,0x29},    //0x0e}, //0x0e      0x0e
  {0x581F,0x17},    //0x29}, //0x29      0x18
  {0x5820,0x11},    //0x17}, //0x17      0x12
  {0x5821,0x11},    //0x11}, //0x11      0x0f
  {0x5822,0x15},    //0x11}, //0x11      0x0f
  {0x5823,0x28},    //0x15}, //0x15      0x12
  {0x5824,0x46},    //0x28}, //0x28      0x1a
  {0x5825,0x26},    //0x46}, //0x46      0x0a
  {0x5826,0x08},    //0x26}, //0x26      0x0a
  {0x5827,0x26},    //0x08}, //0x08      0x0a
  {0x5828,0x64},    //0x26}, //0x26      0x0a
  {0x5829,0x26},    //0x64}, //0x64      0x46
  {0x582A,0x24},    //0x26}, //0x26      0x2a
  {0x582B,0x22},    //0x24}, //0x24      0x24
  {0x582C,0x24},    //0x22}, //0x22      0x44
  {0x582D,0x24},    //0x24}, //0x24      0x24
  {0x582E,0x06},    //0x24}, //0x24      0x28
  {0x582F,0x22},    //0x06}, //0x06      0x08
  {0x5830,0x40},    //0x22}, //0x22      0x42
  {0x5831,0x42},    //0x40}, //0x40      0x40
  {0x5832,0x24},    //0x42}, //0x42      0x42
  {0x5833,0x26},    //0x24}, //0x24      0x28
  {0x5834,0x24},    //0x26}, //0x26      0x0a
  {0x5835,0x22},    //0x24}, //0x24      0x26
  {0x5836,0x22},    //0x22}, //0x22      0x24
  {0x5837,0x26},    //0x22}, //0x22      0x26
  {0x5838,0x44},    //0x26}, //0x26      0x28
  {0x5839,0x24},    //0x44}, //0x44      0x4a
  {0x583A,0x26},    //0x24}, //0x24      0x0a
  {0x583B,0x28},    //0x26}, //0x26      0x0c
  {0x583C,0x42},    //0x28}, //0x28      0x2a
  {0x583D,0xce},    //0x42}, //0x42      0x28
  {0x5025, 0x00},
  //EV
  {0x3a0f,0x30}, 
  {0x3a10,0x28}, 
...
//	{0x3031,0x00},//0x08}, //disable internal LDO,B3=1 bypass regulator
//  {0x4005,0x1a},
//  //power down release
//	{0x503d,0x80}, //0xd2 square test pattern
//	{0x4741,0x00},
  {0x3008,0x02}, //release from reset and power on
  //{REG_TERM,VAL_TERM},
#endif
};                                                           

struct regval_list config_720p_15[] = {
#ifndef REG_DEBUG1
//      { 0x3212, 0x03},
	//{ 0x3103, 0x11 },
	//{ 0x3008, 0x82},
...
struct regval_list config_720p_30[] = {
...
struct regval_list config_720p_60[] = {
	{0x3008, 0x42},
	{0x3103, 0x03},
	{0x3017, 0x00},
	{0x3018, 0x00},
...
struct regval_list config_1080p[] = {
	{0x3103, 0x11},
	{0x3008, 0x42},
	{0x3103, 0x03},
	{0x3017, 0x00},
...
struct regval_list config_vga_15[] = {
	{0x3008, 0x42},
	{0x3103, 0x03},
	{0x3017, 0x00},
	{0x3018, 0x00},
...
struct regval_list config_vga_30[] = {
	{0x3008, 0x42},
	{0x3103, 0x03},
	{0x3017, 0x00},
	{0x3018, 0x00},
...
struct regval_list config_vga_60[] = {
	{0x3008, 0x42},
	{0x3103, 0x03},
	{0x3017, 0x00},
	{0x3018, 0x00},
...
struct regval_list config_qvga_15[] = {
	{0x3008, 0x42},		//power off
	{0x3103, 0x03},		//from pll
	{0x3017, 0x00},		//VSYNC input
	{0x3018, 0x00},		//data io is input
	{0x3034, 0x18},		//mipi mode is 8-bites
	{0x3035, 0x41},		//pll scale divider for mipi
	{0x3036, 0x54},		//pll multipliter
	{0x3037, 0x13},		//pll root divider
	{0x3108, 0x01},		//sclk=pll_clki/2
	{0x3814, 0x31},		//horizontal odd subsapling incerement is 3,even subsampling incerement is 1
	{0x3815, 0x31},		//veritical odd subsampling incerement is 3,even subsampling incerement is 1
//x address start is 0,y address start is 0xfa
	{0x3800, 0x00},
	{0x3801, 0x00},
	{0x3802, 0x00},
	{0x3803, 0xfa},
//x address end is 0x0a3f,y address end is 0x06a9
	{0x3804, 0x0a},
	{0x3805, 0x3f},
	{0x3806, 0x06},
	{0x3807, 0xa9},
	...
	{0x3808, 0x01},
	{0x3809, 0xe0},		//width=480
	{0x380a, 0x01},
	{0x380b, 0x40},		//height=320
	{0x380c, 0x07},
	{0x380d, 0x64},
	{0x380e, 0x02},
	{0x380f, 0xe4},
//x_offset y_offset are 16 and 4
	{0x3810, 0x00},
	{0x3811, 0x10},
	{0x3812, 0x00},
	{0x3813, 0x04},
	...
	{0x4827, 0x16},
	{0x3824, 0x04},
	{0x5001, 0x83},		//awb enable and color matrix enable
	{0x4800, 0x34}

};

struct regval_list config_qvga_30[] = {
	{0x3008, 0x42},		//power off
	{0x3103, 0x03},		//from pll
	{0x3017, 0x00},		//VSYNC input
	{0x3018, 0x00},		//data io is input
...
struct regval_list config_qvga_60[] = {
	{0x3008, 0x42},		//power off
	{0x3103, 0x03},		//from pll
	{0x3017, 0x00},		//VSYNC input
	{0x3018, 0x00},		//data io is input
...
static struct sensor_win_size sensor_win_sizes[] = {
 ...
 /* {
    ...
    .gain_max   = 12<<4,
    .regs       = config_5mp,
    .regs_size  = ARRAY_SIZE(config_5mp),
    .set_size   = NULL,
  },*/
  /* qxga: 2048*1536 */
 // {
 ...
 /* {
  ...
  /* 720p */
  {
    ...
    .hoffset    = 0,
      ...
      .gain_max   = 12<<4,
    .regs       = config_720p_15,
    .regs_size  = ARRAY_SIZE(config_720p_15),
    .set_size   = NULL,
  },
  /* XGA */
  /*{
 ...
 /* {
    ...
    .height     = VGA_HEIGHT,
      ...
      .gain_max   = 10<<4,
    .regs       = config_vga_15,
    .regs_size  = ARRAY_SIZE(config_vga_15),
    .set_size   = NULL,
  },*/
};
