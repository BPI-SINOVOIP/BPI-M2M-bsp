...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for OV2718 Raw sensors");
MODULE_LICENSE("GPL");

/*for internel driver debug*/
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) printk(KERN_DEBUG"[OV2718 Raw]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) printk(KERN_ERR"[OV2718 Raw]"x, ##arg)
#define vfe_dev_print(x, arg...) printk(KERN_INFO"[OV2718 Raw]"x, ##arg)
