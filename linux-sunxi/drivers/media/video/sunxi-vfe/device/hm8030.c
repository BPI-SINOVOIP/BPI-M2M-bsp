...
static struct regval_list sensor_1080p_regs[] = { //1080: 1920*1080@30fps
	...
	//{0x034C,0x05},
	//{0x034D,0x00},//x output size
	//{0x034E,0x02},
	//{0x034F,0xd0},//y output size
	//{0x0100,0x01},
};
...
{ //return 0;
  unsigned char explow,exphigh,expmid;
  struct sensor_info *info = to_state(sd);
...
// printk("hm8030 sensor_set_exp = %d, Done!\n", exp_val);
...
{//return 0;
 ...
 //printk("hm8030 sensor_set_gain = %d, Done!\n", gain_val);
  info->gain = gain_val;
...
static int sensor_s_sw_stby(struct v4l2_subdev *sd, int on_off)
{
  ...
  {
    ret=sensor_write(sd, 0x0103, 0x00);
  }
  return ret;
}
