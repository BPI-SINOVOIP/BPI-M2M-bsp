...
#define DEV_DBG_EN      1
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[ov8858_r2a_4lane]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[ov8858_r2a_4lane]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[ov8858_r2a_4lane]"x,##arg)
...
static struct regval_list sensor_uxga_regs[] = {
    ...
    { 0x4027, 0x2b },  // ; Anchor right end L
    { 0x402b, 0x04 },  // ; top black line number
    { 0x402f, 0x04 },  // ; interpolation x disable, interpolation y disable, Anchor one disable
    { 0x4500, 0x58 },  //
    { 0x4600, 0x00 },  //
    { 0x4601, 0xcb },  //
    { 0x382d, 0x7f },  //
