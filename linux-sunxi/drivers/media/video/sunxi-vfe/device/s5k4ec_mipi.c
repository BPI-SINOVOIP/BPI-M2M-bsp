...
//20120201 : Flash?? ????? Green Noise ???? setting 
...
{0x002A, 0x0204},  
{0x0F12, 0x0061},  //#REG_TC_IPRM_CM_Init_GpioConfig1
{0x002A, 0x020C},  
{0x0F12, 0x2F0C},  //#REG_TC_IPRM_CM_Init_Mi2cBits //[11:10] SDA [9:8]SCL
...
{0x002A, 0x163E},  
{0x0F12, 0x00E5},  //#af_search_usPeakThr      //Full search  ( C0 75%)
...
{0x0F12, 0x0020}, //#awbb_BGainOff
{0x0F12, 0x0030}, //#awbb_GGainOff
...
{0x0F12,0x0002},//REG_TC_IPRM_UseNMipiClocks       0x0002                                     
...
{0x002A, 0x058C},
{0x0F12, 0x3408},   	//lt_uMaxExp1		// 33.3ms
{0x0F12, 0x0000},
{0x0F12, 0x6810},   	//lt_uMaxExp2		// 66.6ms
{0x0F12, 0x0000},
{0x0F12, 0x6810},   	//lt_uCapMaxExp1	// 66.6ms
{0x0F12, 0x0000},
{0x0F12, 0xD048},   	//lt_uCapMaxExp2	// 133.3ms
{0x0F12, 0x0000},
{0x002A, 0x059C},
{0x0F12, 0x0400},   	//lt_uMaxAnGain1	// X4
{0x0F12, 0x0C00},   	//lt_uMaxAnGain2	// X12 //0800 X8
{0x0F12, 0x0100},   	//lt_uMaxDigGain	// X1
{0x0F12, 0x0A00},   	//lt_uMaxTotGain	// X10
...
{0x0f12, 0x0000},
{0x0f12, 0x0028},
{0x0f12, 0x0000},   //0xFFE8
{0x0f12, 0x0050},
//==================================================================================
// 17.AFIT
//==================================================================================
{0x002A,0x0944},
{0x0F12,0x0030},	// afit_uNoiseIndInDoor  0x0050  0x0010
{0x0F12,0x0080},	// afit_uNoiseIndInDoor  0x00B0  0x0020
{0x0F12,0x0100},	// afit_uNoiseIndInDoor  0x0196  0x0100
...
{0x0F12, 0xFFE0}, //70000990//AFIT16_SATURATION
...
{0x0F12, 0x0418}, //700009E4//AFIT8_ee_iWSharpen[7:0]AFIT8_ee_iMShThresh 0x0418  0x0438
...
{0x0F12, 0x2A36}, //70000A26//AFIT8_bnr_iDenThreshLow[7:0]AFIT8_bnr_iDenThreshHigh 0x2A36  0x0a0a
...
{0x0F12, 0xFFE8}, //70000A46//AFIT16_SATURATION
...
{0x0F12, 0x041c}, //70000A9A//AFIT8_ee_iWSharpen[7:0]AFIT8_ee_iMShThresh 0x0448  0x0448
...
{0x0F12, 0x1B24}, //70000ADC//AFIT8_bnr_iDenThreshLow[7:0]AFIT8_bnr_iDenThreshHigh  0x1B24  0x0808
...
{0x0F12, 0xFFF0}, //70000AFC//AFIT16_SATURATION
...
{0x0F12, 0x0428}, //70000B50//AFIT8_ee_iWSharpen[7:0]AFIT8_ee_iMShThresh 0x0428  0x0458
...
{0x0F12, 0x141D}, //70000B92//AFIT8_bnr_iDenThreshLow[7:0]AFIT8_bnr_iDenThreshHigh 0x141D  0x0606
{0x0F12, 0xc080}, //70000B94//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
{0x0F12, 0xFFF8}, //70000BB2//AFIT16_SATURATION
...
{0x0F12, 0x042C}, //70000C06//AFIT8_ee_iWSharpen[7:0]AFIT8_ee_iMShThresh  0x042C  0x0460
...
{0x0F12, 0x1117}, //70000C48//AFIT8_bnr_iDenThreshLow[7:0]AFIT8_bnr_iDenThreshHigh  0x1117  0x0505
{0x0F12, 0xc088}, //70000C4A//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
{0x0F12, 0x0460}, //70000CBC//AFIT8_ee_iWSharpen[7:0]AFIT8_ee_iMShThresh 0x0430
...
{0x0F12, 0x0C0F}, //70000CFE//AFIT8_bnr_iDenThreshLow[7:0]AFIT8_bnr_iDenThreshHigh  0x0404
{0x0F12, 0xc0a0}, //70000D00//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
{0x0F12, 0x0001}, //70000D18AFITB_bnr_nClustLevel_C[0]bWideWide[1]
...
{0x0F12,0x4F1A},  //REG_0TC_PCFG_usMaxOut4KHzRate     0x279D                                     
{0x0F12,0x4F1A}, //REG_0TC_PCFG_usMinOut4KHzRate       0x277D                                  
...
{0x0F12,0x4F1A},  //REG_1TC_PCFG_usMaxOut4KHzRate                                        
{0x0F12,0x4F1A},  //REG_1TC_PCFG_usMinOut4KHzRate                                        
...
{0x0F12,0x4F1A},  //REG_2TC_PCFG_usMaxOut4KHzRate                                        
{0x0F12,0x4F1A}, //REG_2TC_PCFG_usMinOut4KHzRate                                        
...
{0x0F12,0x4F1A},  //REG_3TC_PCFG_usMaxOut4KHzRate                                        
{0x0F12,0x4F1A},  //REG_3TC_PCFG_usMinOut4KHzRate                                        
...
{0x0F12, 0x4F1A},	 //4F1A	 //REG_0TC_PCFG_usMaxOut4KHzRate     	
{0x0F12, 0x4F1A},	 //4F1A	 //REG_0TC_PCFG_usMinOut4KHzRate     	
{0x0F12, 0x0100},	 //REG_0TC_PCFG_OutClkPerPix88       	
{0x0F12, 0x0300},	 //REG_0TC_PCFG_uBpp88               	
{0x0F12, 0x0012},	 //REG_0TC_PCFG_PVIMask              	
{0x0F12, 0x0000},	 //REG_0TC_PCFG_OIFMask              	
...
{0x0F12, 0x0000},	//REG_0TC_PCFG_usFrTimeType
{0x0F12, 0x0001},	//REG_0TC_PCFG_FrRateQualityType
{0x0F12, 0x07D0},	//  REG_0TC_PCFG_usMaxFrTimeMsecMult10  0x014D 0x0535
{0x0F12, 0x014D},	//   REG_0TC_PCFG_usMinFrTimeMsecMult10  
...
{0x002A, 0x02A6},
{0x0F12, 0x0500},	//280 REG_0TC_PCFG_usWidth
{0x0F12, 0x03C0},	//1E0 REG_0TC_PCFG_usHeight
{0x0F12, 0x0005},
{0x002A, 0x02BC},
{0x0F12, 0x0000},	//REG_0TC_PCFG_uClockInd
{0x0F12, 0x0000},	//REG_0TC_PCFG_usFrTimeType
{0x0F12, 0x0001},	//REG_0TC_PCFG_FrRateQualityType
{0x0F12, 0x07D0},	//  REG_0TC_PCFG_usMaxFrTimeMsecMult10  0320    0x0535
{0x0F12, 0x014D},	//   REG_0TC_PCFG_usMinFrTimeMsecMult10  
...
static struct regval_list sensor_SVGA_regs[] = { //800*600
/* preview setting */
{0xFCFC, 0xD000}, //
{0x0028, 0x7000}, //
{0x002A, 0x18AC},
