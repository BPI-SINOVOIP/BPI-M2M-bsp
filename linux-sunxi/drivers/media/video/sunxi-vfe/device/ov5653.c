 ...
 */
/*
 * A V4L2 driver for OV ov5653 cameras.
 */
...
MODULE_DESCRIPTION("A low-level driver for OV5653 sensors");
MODULE_LICENSE("GPL");

//for internel driver debug
#define DEV_DBG_EN      0 
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[OV5653]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[OV5653]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[OV5653]"x,##arg)
...
#define V4L2_IDENT_SENSOR 0x5653
...
/*
 * The ov5653 sits on i2c with ID 0x6c
 */
...
static struct regval_list sensor_720p_regs[] = { //720: 1280*720@30fps //48MHz pclk
	...
	{0x3011,0x10},//PLL2
	{0x3012,0x05},//PLL3
	{0x3800,0x02},//0x02},//HREF start[11:8]
	{0x3801,0x54},//0x54},//HREF start[7:0]
	{0x3802,0x00},//VREF start[11:8]
	...
	{0x380c,0x08},//0x08},//HTS[11:8]
	{0x380d,0x72},//0x72},//HTS[7:0]
...
static int sensor_s_exp(struct v4l2_subdev *sd, unsigned int exp_val)
{
	...
	vfe_dev_dbg("5653 sensor_set_exp = %d, Done!\n", exp_val);
...
static int sensor_s_exp_gain(struct v4l2_subdev *sd, struct sensor_exp_gain *exp_gain)
{
	...
	printk("data in: exp_val = %d, gain_val = %d\n",exp_val,gain_val);
  ...
  sensor_write(sd, 0x3208, 0x00);//enter group write
	...
	gainhigh=(unsigned char)((gain_val>>8)&0x1);
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	...
	printk("5653 sensor_set_gain = %d, Done!\n", gain_val);
	info->gain = gain_val;
		...
		struct v4l2_queryctrl *qc)
{
	...
	switch (qc->id) {
		...
		case V4L2_CID_FRAME_RATE:
			return v4l2_ctrl_query_fill(qc, 0, 120, 1, 0);
	}
	return -EINVAL;
}
