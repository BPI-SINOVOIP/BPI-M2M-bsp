...
#define DEV_DBG_EN      1
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[OV8858_4lane]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[OV8858_4lane]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[OV8858_4lane]"x,##arg)
...
#define SENSOR_NAME "ov8858_4lane"
