/*
 * A V4L2 driver for gc2023_mipi_1lane Raw cameras.
 *
 */
...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for gc2023_mipi_1lane Raw sensors");
MODULE_LICENSE("GPL");
...
#define vfe_dev_dbg(x, arg...) \
	printk(KERN_DEBUG"[gc2023_mipi_1lane Raw]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) \
	printk(KERN_ERR"[gc2023_mipi_1lane Raw]"x, ##arg)
#define vfe_dev_print(x, arg...) \
	printk(KERN_INFO"[gc2023_mipi_1lane Raw]"x, ##arg)
...
/*
 * The gc2023_mipi_1lane i2c address
 */
#define I2C_ADDR 0x6e
#define  SENSOR_NAME "gc2023_mipi_1lane"
...
static struct regval_list sensor_default_regs[] = {
	/*
	////////////////////////////////////////////////////////////////
	///HD=2840,PCLK=96MHz,MIPI clock=384MHz,row time=29.58us////////
	///////////////////////SYS /////////////////////////////////////
	///////////////////////////////////////////////////////////////
	*/
{0xfe, 0x80},
...
static int sensor_s_gain(struct v4l2_subdev *sd, int gain_val)
{
	unsigned int Analog_Multiple[12] = {
		1000, 1400, 2000, 2840, 4080, 5980, 8660, 12600,
		17600, 25000, 35600, 52000
	};
