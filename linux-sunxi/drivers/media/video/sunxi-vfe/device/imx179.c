...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) printk(KERN_DEBUG"[IMX179]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) printk(KERN_ERR"[IMX179]"x, ##arg)
#define vfe_dev_print(x, arg...) printk(KERN_INFO"[IMX179]"x, ##arg)
...
#endif
	vfe_dev_dbg("norm exp_val = %d,gain_val = %d," \
		"frame_length = %d,imx179_sensor_vts = %d 30a2 0x%x\n",
