...
#define vfe_dev_dbg(x, arg...) \
	printk(KERN_WARNING"[CSI_DEBUG][NT99141]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) printk(KERN_ERR"[CSI_ERR][NT99141]"x, ##arg)
#define vfe_dev_print(x, arg...) printk(KERN_INFO"[CSI][NT99141]"x, ##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	{0x3109, 0x04},		/* use external power */
	{0x3040, 0x04},
	{0x3041, 0x02},
	{0x3042, 0xFF},
	{0x3043, 0x08},
	...
	{0x3366, 0x80},
	{0x3367, 0x60},
	{0x3368, 0xB0},		/* Edge_Enhance_L_0 */
	{0x3369, 0x9C},
	{0x336A, 0x80},
	{0x336B, 0x58},
	{0x336C, 0x00},		/* EE_Weight_H */
	{0x336D, 0x20},		/* NR_DPC_Ratio_0 */
	{0x336E, 0x1C},
	{0x336F, 0x18},
	{0x3370, 0x11},
	{0x3371, 0x30},		/* NR_Weight_0 */
	{0x3372, 0x38},
	{0x3373, 0x3F},
	{0x3374, 0x3F},
	...
	{0x32B8, NT99141_REG_0X32B8},
	{0x32B9, NT99141_REG_0X32B9},
	{0x32BB, 0x87},
	{0x32BC, NT99141_REG_0X32BC},
	{0x32BD, NT99141_REG_0X32BD},
	{0x32BE, NT99141_REG_0X32BE},
...
static int sensor_g_hflip(struct v4l2_subdev *sd, __s32 *value)
{
	...
	vfe_dev_dbg("NT99141 sensor_read sensor_g_hflip(%x)\n", val);
...
static int sensor_g_vflip(struct v4l2_subdev *sd, __s32 *value)
{
	...
	vfe_dev_dbg("NT99141 sensor_read sensor_g_vflip(%x)\n", val);
...
static int sensor_detect(struct v4l2_subdev *sd)
{
	...
	vfe_dev_dbg("nt99141_SENSOR_ID=%x\n", val);
	SENSOR_ID |= (val << 8);
...
static int sensor_g_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *parms)
{
	...
	vfe_dev_dbg("[King]----------------- info->tpf.denominator=%d\n",
...
static int sensor_s_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *parms)
{
	...
	switch (fps) {
	case 30:
		vfe_dev_dbg("switch fps to 30.\n");
		/* sensor_write_array(sd, sensor_720P_regs_30fps,
		...
		break;
	case 25:
		vfe_dev_dbg("switch fps to 25.\n");
		/* sensor_write_array(sd, sensor_720P_regs_25fps,
		...
		break;
	case 20:
		vfe_dev_dbg("switch fps to 20.\n");
		/* sensor_write_array(sd, sensor_720P_regs_20fps,
		...
		break;
	case 15:
		vfe_dev_dbg("switch fps to 15.\n");
		/* sensor_write_array(sd, sensor_720P_regs_15fps,
		...
		break;
	default:
		vfe_dev_dbg("switch fps to nothing.\n");
		break;
...
/*
	...
	vfe_dev_dbg("[King]------------info->tpf.denominator is %d\n",
			info->tpf.denominator);
	...
	if (info->capture_mode == V4L2_MODE_IMAGE) {
		vfe_dev_dbg("capture mode is not video mode,"
			"can not set frame rate!\n");
		return 0;
	}
	...
	if (tpf->numerator == 0 || tpf->denominator == 0) {
		...
		vfe_dev_dbg("sensor frame rate reset to full rate!\n");
	}

	div = SENSOR_FRAME_RATE/(tpf->denominator/tpf->numerator);
	if (div > 15 || div == 0) {
		vfe_dev_dbg("SENSOR_FRAME_RATE=%d\n",SENSOR_FRAME_RATE);
		vfe_dev_dbg("tpf->denominator=%d\n",tpf->denominator);
		vfe_dev_dbg("tpf->numerator=%d\n",tpf->numerator);
		return -EINVAL;
	}
