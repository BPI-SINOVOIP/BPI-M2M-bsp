...
unsigned int bsp_isp_set_size(enum pixel_fmt *fmt, struct isp_size *ob_black_size, struct isp_size *ob_valid_size,struct isp_size *ob_rot_size,struct coor *ob_start,struct isp_size *scale_size){return 0;}
