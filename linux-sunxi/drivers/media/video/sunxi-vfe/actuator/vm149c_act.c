...
#define SUNXI_ACT_NAME "vm149c_act"
...
#define act_dev_err(x,arg...) printk(KERN_ERR"[ACT_ERR][vm149c_act]"x,##arg)

//print unconditional, for important info
#if ACT_DEV_DBG_EN == 1
#define act_dev_dbg(x,arg...) printk(KERN_INFO"[ACT][vm149c_act]"x,##arg)
#else
...
MODULE_DESCRIPTION("vm149c vcm actuator");
