/*
 * drivers/video/sunxi/disp/de/lowlevel_sun8iw5/de_lcd.c
 *
...
static __s32 tcon0_cfg_mode_auto(__u32 sel, disp_panel_para * panel)
{
	__s32 start_delay;
...
static __s32 tcon0_cfg_mode_tri(__u32 sel, disp_panel_para * panel)
{
	u32 start_delay = 0;
	lcd_dev[sel]->tcon0_basic0.bits.x = panel->lcd_x-1;
	lcd_dev[sel]->tcon0_basic0.bits.y = panel->lcd_y-1;
...
__s32 tcon0_cfg(__u32 sel, disp_panel_para * panel)
{
	...
	lcd_dev[sel]->tcon_volume_ctl.bits.safe_period_fifo_num = 3000;//panel->lcd_dclk_freq*15;
...
static __disp_timing_t tv_timing_tbl[30]	= {
...
static __u32 tcon_ceu_range_cut(__s32 *x_value,__s32 x_min,__s32 x_max)
{
	if(*x_value>x_max)
	{
		*x_value = x_max;
...
static __s32 tcon_ceu_reg_corr(__s32 val,__u32 bit)
{
	if(val>=0)
		return val;
	else
...
static __s32 tcon_ceu_rect_multi(__s32 *dest, __s32 *src1, __s32 *src2)
{
	__u32 x,y,z;
	__s64 val_int64;
...
static __s32 tcon_ceu_rect_calc(__s32 *p_rect,__s32 b,__s32 c,__s32 s,__s32 h)
{
...
static __s32 tcon_ceu_calc(__u32 r2y_type,__u32 cen_type,__u32 y2r_type, __s32 b,__s32 c,__s32 s,__s32 h,__s32* p_coff)
{
