/*
 * drivers/video/sunxi/disp/de/lowlevel_sun9iw1/de_be.h
 *
...
extern u32 image_reg_base[3];
#define DE_BE_GET_REG_BASE(sel)    (image_reg_base[sel])

#define DE_WUINT8(offset,value)             (*((volatile u8 *)(offset))=(value))
#define DE_RUINT8(offset)                   (*((volatile u8 *)(offset)))
#define DE_WUINT16(offset,value)            (*((volatile u16 *)(offset))=(value))
#define DE_RUINT16(offset)                  (*((volatile u16 *)(offset)))
#define DE_WUINT32(offset,value)            (*((volatile u32 *)(offset))=(value))
#define DE_RUINT32(offset)                  (*((volatile u32 *)(offset)))
#define DE_WUINT8IDX(offset,index,value)    ((*((volatile u8 *)(offset+index)))=(value))
#define DE_RUINT8IDX(offset,index)          (*((volatile u8 *)(offset+index)))
#define DE_WUINT16IDX(offset,index,value)   (*((volatile u16 *)(offset+2*index))=(value))
#define DE_RUINT16IDX(offset,index)         ( *((volatile u16 *)(offset+2*index)))
#define DE_WUINT32IDX(offset,index,value)   (*((volatile u32 *)(offset+4*index))=(value))
#define DE_RUINT32IDX(offset,index)         (*((volatile u32 *)(offset+4*index)))
...
extern u32  csc_tab[192];
extern u32  image_enhance_tab[256];
extern u32  fir_tab[1792];
