/*
 * drivers/video/sunxi/disp/de/lowlevel_sun9iw1/iep_cmu.h
 *
...
//
//------------------------------------------------------------------------------------------------------------
#ifndef __IEP_CMU__H__
#define __IEP_CMU__H__
...
#define get_wvalue(n)	(*((volatile u32 *)(n)))			/* word input */
#define put_wvalue(n,c)	(*((volatile u32 *)(n)) = (c))	/* word output */
...
extern u32 hsv_range_par[21];
extern u32 hsv_adjust_vivid_par[16];
extern u32 hsv_adjust_flesh_par[16];
extern u32 hsv_adjust_scenery_par[16];
