...
static inline void rot_0_u8 (unsigned char *src_addr,
		const unsigned int src_widthstep,
...
static inline void rot_0_u16(unsigned short *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
...
static inline void rot_0_u32(unsigned int *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
...
static inline void rot_180_u8(unsigned char *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned char *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_180_u16(unsigned short *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned short *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_180_u32(unsigned int *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned int *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_u8(unsigned char *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned char *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_u16(unsigned short *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned short *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_u32(unsigned int *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned int *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_90_u8(unsigned char *src_addr,
		const unsigned int src_widthstep,
...
static inline void rot_90_u16(unsigned short *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
		unsigned short *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_90_u32(unsigned int *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
		unsigned int *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_180_seq_w_u8(unsigned char *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned char *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_180_seq_w_u16(unsigned short *src_addr,
		const unsigned int src_widthstep,
		const unsigned int src_width, const unsigned int src_height,
	unsigned short *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_180_seq_w_u32(
...
static inline void rot_90_seq_w_u8(
...
static inline void rot_90_seq_w_u16(
...
static inline void rot_90_seq_w_u32(
	unsigned int *src_addr, const unsigned int src_widthstep,
	const unsigned int src_width, const unsigned int src_height,
	unsigned int *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_seq_w_u8(
	unsigned char *src_addr, const unsigned int src_widthstep,
    const unsigned int src_width, const unsigned int src_height,
	unsigned char *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_seq_w_u16(
	unsigned short *src_addr, const unsigned int src_widthstep,
    const unsigned int src_width, const unsigned int src_height,
	unsigned short *dst_addr, const unsigned int dst_widthstep)
{
...
static inline void rot_270_seq_w_u32(
	unsigned int *src_addr,	const unsigned int src_widthstep,
    const unsigned int src_width, const unsigned int src_height,
	unsigned int *dst_addr, const unsigned int dst_widthstep)
{
