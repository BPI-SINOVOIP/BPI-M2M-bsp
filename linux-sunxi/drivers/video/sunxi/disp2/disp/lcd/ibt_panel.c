/*
 * drivers/video/sunxi/disp2/disp/lcd/ibt_panel.c
 *
...
{                                                                                                                         
	s32 value = 0;                                                                                                          
	disp_sys_script_get_item("lcd0_para", "lcd_tcon_fix", &value, 1);                                                       
	if(value){                                                                                                              
		...
		LCD_OPEN_FUNC(sel, LCD_panel_init, 300);   //open lcd power, than delay 200ms                                         
		LCD_OPEN_FUNC(sel, LCD_bl_open, 0);     //open lcd backlight, and delay 0ms                                           
		DE_INF("===========lcd_tcon_fix mode\n");                                                                             
	}else{                                                                                                                  
		LCD_OPEN_FUNC(sel, LCD_power_on, 30);   //open lcd power, and delay 50ms                                              
		LCD_OPEN_FUNC(sel, LCD_panel_init, 50);   //open lcd power, than delay 200ms                                          
		LCD_OPEN_FUNC(sel, sunxi_lcd_tcon_enable, 500);     //open lcd controller, and delay 100ms                            
		LCD_OPEN_FUNC(sel, LCD_bl_open, 0);     //open lcd backlight, and delay 0ms                                           
	}                                                                                                                       
	return 0;                                                                                                               
}                                                                                                                         
