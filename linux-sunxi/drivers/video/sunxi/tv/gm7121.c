...
void gm7121_init(disp_tv_mode tv_mode)
{
    ...
    GM7121_Config(0x3A,0x13);   //data	Ö÷Ä£Ê½
    //*GM7121_Config(0x3A,0x03);     //sync from rcv1 and rcv2   ´ÓÄ£Ê½
...
#endif       
    GM7121_Config(0x6B,0x12);    //Ö÷Ä£Ê½
    //GM7121_Config(0x6B,0x20);     // ´ÓÄ£Ê½
    //*GM7121_Config(0x6B,0x00);     // ´ÓÄ£Ê½ 7121C 20110105
    
    GM7121_Config(0x6C,0x01);    //Ö÷Ä£Ê½	
    //GM7121_Config(0x6C,0x96);    //´ÓÄ£Ê½	
    //GM7121_Config(0x6C,0x51);    //´ÓÄ£Ê½	 7121C 20110105
    //*GM7121_Config(0x6C,0x06);    //´ÓÄ£Ê½
    
    GM7121_Config(0x6D,0x20);    //Ö÷Ä£Ê½
    //GM7121_Config(0x6D,0x18);    //´ÓÄ£Ê½ 
    //GM7121_Config(0x6D,0x11);    //´ÓÄ£Ê½  7121C 20110105
    //*GM7121_Config(0x6D,0x00);    //´ÓÄ£Ê½ 
