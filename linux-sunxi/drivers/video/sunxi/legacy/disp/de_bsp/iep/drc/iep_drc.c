/*
 * drivers/video/sunxi/legacy/disp/de_bsp/iep/drc/iep_drc.c
 *
...
static __u32 PWRSAVE_PROC_THRES = 85; //when bsp_disp_lcd_get_bright() exceed PWRSAVE_PROC_THRES, STOP PWRSAVE.
