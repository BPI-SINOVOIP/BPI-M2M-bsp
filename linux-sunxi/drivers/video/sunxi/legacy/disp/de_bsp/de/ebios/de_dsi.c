/*
 * drivers/video/sunxi/legacy/disp/de_bsp/de/ebios/de_dsi.c
 *
...
static __s32 dsi_set_max_ret_size(__u32 sel,__u32 size)
{
...
static __s32 dsi_dphy_cfg(__u32 sel,__panel_para_t * panel)
{
...
static __s32 dsi_basic_cfg(__u32 sel,__panel_para_t * panel)
{
...
static __s32 dsi_packet_cfg(__u32 sel,__panel_para_t * panel)
{
	if(panel->lcd_dsi_if == LCD_DSI_IF_COMMAND_MODE)
	{
