/*
 * drivers/video/sunxi/legacy/disp/de_bsp/de/ebios/de_lcd.c
 *
...
static __s32 tcon0_cfg_mode_auto(__u32 sel, __panel_para_t * panel)
{
	__s32 start_delay;
...
static __s32 tcon0_cfg_mode_tri(__u32 sel, __panel_para_t * panel)
{
	lcd_dev[sel]->tcon0_basic0.bits.x = panel->lcd_x-1;
	lcd_dev[sel]->tcon0_basic0.bits.y = panel->lcd_y-1;
