...
extern void  Hdmi_set_sw_init_flag(__u8 flag);
extern __u8  Hdmi_get_sw_init_flag(void);
...
extern __s32 Hdmi_hal_set_state(__s32 state);
extern __s32 Hdmi_hal_set_video_enable(__s32 en);
...
extern __s32 Hdmi_hal_get_vendor_id(__u8 *id);
