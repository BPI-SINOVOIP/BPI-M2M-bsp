...
static const struct snd_kcontrol_new ac_ladcmix_controls[] = {
	...
	SOC_DAPM_SINGLE("l_out mixer Switch", L_ADCMIX_SRC, LADCMIXMUTELOUTPUT, 1, 0),
	SOC_DAPM_SINGLE("r_out mixer Switch", L_ADCMIX_SRC, LADCMIXMUTEROUTPUT, 1, 0),
};
...
static const struct snd_kcontrol_new ac_radcmix_controls[] = {
	...
	SOC_DAPM_SINGLE("r_out mixer Switch", R_ADCMIX_SRC, RADCMIXMUTEROUTPUT, 1, 0),
	SOC_DAPM_SINGLE("l_out mixer Switch", R_ADCMIX_SRC, RADCMIXMUTELOUTPUT, 1, 0),
};
...
static const struct snd_soc_dapm_route ac_dapm_routes[] = {
	...
	{"LEFT ADC input Mixer", "l_out mixer Switch",				"Left Output Mixer"},
	{"LEFT ADC input Mixer", "r_out mixer Switch",				"Right Output Mixer"},
	...
	{"RIGHT ADC input Mixer", "r_out mixer Switch",				"Right Output Mixer"},
	{"RIGHT ADC input Mixer", "l_out mixer Switch",				"Left Output Mixer"},
