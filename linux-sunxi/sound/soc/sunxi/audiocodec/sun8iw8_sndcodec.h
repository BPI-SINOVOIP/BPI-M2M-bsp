...
#define LADC_MIX_MUTE		  		  (0x0C)
#define RADC_MIX_MUTE				  (0x0D)
#define PA_ANTI_POP_CTRL				  (0x0E)
#define AC_ADC_CTRL				  (0x0F)

#define OPADC_CTRL				  (0x10)
#define OPMIC_CTRL				  (0x11)
#define ZERO_CROSS_CTRL				  (0x12)
#define ADC_FUN_CTRL		                (0x13)
#define CALIBRTAION_CTRL		                (0x14)
