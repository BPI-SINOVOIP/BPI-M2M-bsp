#ifndef _PM_CONFIG_SUN8IW9P1_H
#define _PM_CONFIG_SUN8IW9P1_H
...
//debug reg
#if 1 //for real ic
	#define STANDBY_STATUS_REG_PA 	(SUNXI_RTC_PBASE + 0x10c)
...
#define AW_UART_PH_GPIO_PA              (0x01c20800 + 0xFC)            //uart0: use pH4 PH5
...
#define AW_UART_PH_CONFIG_VAL           (0x00330000)
