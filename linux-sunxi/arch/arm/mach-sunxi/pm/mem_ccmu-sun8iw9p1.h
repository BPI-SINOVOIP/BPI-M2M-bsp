 ...
 */
#ifndef __MEM_CCMU_SUN8IW9P1_H__
#define __MEM_CCMU_SUN8IW9P1_H__
...
typedef union{
	...
	__u32   reserved0:6;        //bit2,  reserved
	__u32   CpuApbClkDiv:2;     //bit8, CPU0/1/2/ clock clk div
	...
	__u32   Cpu1ApbClkDiv:2;    //bit24, CPU1/1/2/ clock clk div
...
typedef struct __CCMU_REG_LIST
{
    ...
    volatile __u32                              Pll6Ctl;                //0x0028, PLL6 control, periph0
    volatile __u32                              Pll7Ctl;                //0x002c, PLL7 control, periph1
    volatile __u32                              reserved5;              //0x0030, reserved
    volatile __u32                              Pll24m;                 //0x0034, PLL24M
    volatile __u32		                Pll8Ctl;                //0x0038, PLL8 control, gpu
    volatile __u32                              reserved7;              //0x003c, reserved
    volatile __u32                              PllMipi;                //0x0040,
    ...
    volatile __u32                              reserved8;              //0x005c,
    ...
    volatile __u32                              Ths;                    //0x0074, thermal
    ...
    volatile __u32                              Sd3;                    //0x0094, sd/mmc controller 3 clock
    volatile __u32		                reserved92;             //0x0098, reserved
    volatile __u32		                Ss;		        //0x009c, ss clk
    volatile __u32                              Spi0;                   //0x00a0, spi controller 0 clock
    volatile __u32                              reserved11[10];         //0x00a4, reserved
    volatile __u32                              Usb;                    //0x00cc, usb phy clock
    volatile __u32                              reserved111;            //0x00d0, reserved
    volatile __u32                              reserved12[6];          //0x00d4, reserved
    volatile __u32                              Pllcpucfg;              //0x00ec,
    ...
    volatile __u32                              DeCfg;                  //0x0104, de module clock
    ...
    volatile __u32                              reserved14[6];          //0x0120, reserved
    volatile __u32                              Csi0;                   //0x0134, csi0 module clock
    volatile __u32                              Csi1;                   //0x0138, reserved
    ...
    volatile __u32                              reserved15[5];          //0x0148, reserved
    ...
    volatile __u32                              Ats;                    //0x01B0, reserved
    volatile __u32                              reserved19[19];		//0x01B4-0x200, reserved
    ...
    volatile __u32                              reserved201[2];         //0x0208-0x20c reserved
    volatile __u32                              PllC1CpuxBias;          //0x0210, reserved
    volatile __u32                              reserved202[2];         //0x0214-0x218, reserved
    volatile __u32                              PllPeriph1Bias;         //0x021c, reserved
    ...
    volatile __u32                              reserved2021;           //0x238, pll c1cpux bias reg;
    volatile __u32                              PllGpuBias;		//0x23c, pll gpu bias reg;
    volatile __u32                              PllMipiBias;		//0x240;
    volatile __u32                              PllHsicBias;		//0x244, pll hsic bias reg;
    volatile __u32                              PllDeBias;		//0x248, pll de bias reg;
    volatile __u32                              PllDdr1Bias;            //0x24c, pll Video1 bias reg;

    volatile __u32                              reserved203[2];         //0x250-0x254, reserved
    volatile __u32                              Pll24mBias;             //0x258, pll 24m bias reg;
    volatile __u32                              reserved2031;           //0x25c, reserved
    volatile __u32                              DdrTun;                 //0x260, reserved
    volatile __u32                              reserved204[3];         //0x264-0x26c, reserved
    volatile __u32                              MipiTun;                //0x270, reserved
    volatile __u32                              Pll24mTun;              //0x274, reserved
    volatile __u32                              reserved205;            //0x278, reserved
    volatile __u32                              PllC1Reg0Pattern;       //0x027c, pll audio reg0 pattern
    volatile __u32                              PllC0Reg0Pattern;       //0x0280, reserved
    ...
    volatile __u32                              PllVePattern;           //0x028c, reserved
    volatile __u32                              PllDdrPattern;		//0x0290, pll ddr pattern
    volatile __u32                              PllPeriph1Pattern;      //0x0294, pll ddr pattern
    volatile __u32                              reserved208;            //0x0298
    volatile __u32                              PllGpuPattern;          //0x029c, pll ddr pattern
    volatile __u32                              PllMipiPattern;         //0x02a0, pll ddr pattern
    volatile __u32                              PllHsicPattern;         //0x02a4, pll audio reg1 pattern
    volatile __u32                              PllDePattern;           //0x02a8, pll video0 reg1 pattern
    volatile __u32                              PllDdr1Reg0Pattern;	//0x02ac, reserved
    volatile __u32                              PllDdr1Reg1Pattern;     //0x02b0, pll ddr reg1 pattern
    volatile __u32                              PllC1Reg1Pattern;       //0x02b4, pll audio reg0 pattern
    volatile __u32                              PllC0Reg1Pattern;       //0x02b8, reserved
    volatile __u32                              reserved2081;	        //00x2bc, reserved
