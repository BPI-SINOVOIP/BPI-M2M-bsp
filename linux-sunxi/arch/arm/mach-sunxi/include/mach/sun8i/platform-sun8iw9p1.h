/*
 * arch/arm/mach-sunxi/include/mach/sun8i/platform-sun8iw9p1.h
 *
...
#ifndef __PLATFORM_SUN8I_W9P1_H
#define __PLATFORM_SUN8I_W9P1_H
...
#define SUNXI_MAILBOX_PBASE              0x01c1c000 /* between AP and CP */
#define SUNXI_SMC_PBASE                  0x01c1d000
...
#define SUNXI_SMTA_PBASE                 0x01c2c000
...
#define SUNXI_DRAMPRF_PBASE              0x01c66000
...
#define SUNXI_CP_PCM_PBASE               0x01e32800
#define SUNXI_CP_PWR_PBASE               0x01e35000
#define SUNXI_CP_UART_PBASE              0x01e36000
#define SUNXI_CP_RAM_PBASE               0x01e38000
...
#define SUNXI_R_KEYADC_PBASE             0x01f03c00
#define SUNXI_R_KEYPAD_PBASE             0x01f04000
...
#define SUNXI_MAILBOX_VBASE              IO_ADDRESS(SUNXI_MAILBOX_PBASE          )
...
#define SUNXI_DRAMPRF_VBASE              IO_ADDRESS(SUNXI_DRAMPRF_PBASE      )
...
#define SUNXI_CP_PCM_VBASE               IO_ADDRESS(SUNXI_CP_PCM_PBASE       )
#define SUNXI_CP_PWR_VBASE               IO_ADDRESS(SUNXI_CP_PWR_PBASE       )
#define SUNXI_CP_UART_VBASE              IO_ADDRESS(SUNXI_CP_UART_PBASE      )
#define SUNXI_CP_RAM_VBASE               IO_ADDRESS(SUNXI_CP_RAM_PBASE       )
...
#define SUNXI_R_KEYADC_VBASE             IO_ADDRESS(SUNXI_R_KEYADC_VBASE     )
#define SUNXI_R_KEYPAD_VBASE             IO_ADDRESS(SUNXI_R_KEYPAD_VBASE     )
