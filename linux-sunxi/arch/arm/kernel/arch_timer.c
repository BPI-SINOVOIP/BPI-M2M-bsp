...
#if (defined CONFIG_ARCH_SUN8IW6P1) || (defined CONFIG_ARCH_SUN8IW9P1) || (defined CONFIG_ARCH_SUN9IW1P1)
                                  ...
                                  struct clock_event_device *unused)
{
	...
	printk("notice: set tval failed. cval:0x%llx, tval:0x%lx, evt:0x%lx, pcnt:0x%llx, cvall:0x%x, cvalh:0x%x\n", cval, tval, evt, pcnt, cvall, cvalh);
	arch_timer_reg_write(ARCH_TIMER_REG_CTRL, ctrl);
