 ...
 *
 * @set_p2p_power_mgmt: Set P2P power save parameters
 */
struct cfg80211_ops {
	...
	int	(*set_wiphy_params)(struct wiphy *wiphy, struct net_device *dev,
			u32 changed);
	...
	int	(*set_data_filter)(struct wiphy *wiphy, void *data, int len);
#ifdef CONFIG_XRADIO_TESTMODE
	int	(*update_acm_up)(struct wiphy *wiphy, struct net_device *dev,
 ...
 */
void cfg80211_driver_hang_notify(struct net_device *dev,
				 gfp_t gfp);
