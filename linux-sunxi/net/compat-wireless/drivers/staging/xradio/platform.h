...
#define MCI_RESCAN_CARD(id, ins)   sunxi_mci_rescan_card(id, ins)   /*(sunxi_mmc_rescan_card(id),ins)*/
#define MCI_CHECK_READY(h, t)      sunxi_mci_check_r1_ready(h, t)  /*sunxi_mmc_check_r1_ready(h, t)*/
